...
echo ""
# Resolve o sub-vault AI-Brain de forma portavel (mesma precedencia do vault_sync.py)
AI_BRAIN="${AI_BRAIN_PATH:-${VAULT_PATH:+$VAULT_PATH/AI-Brain}}"
AI_BRAIN="${AI_BRAIN:-$HOME/Documents/Obsidian Vault/AI-Brain}"
echo "== Espelho no vault AI-Brain =="
echo "   /graphify . --obsidian --obsidian-dir \"$AI_BRAIN/wiki/graphs/harness4claude\""
