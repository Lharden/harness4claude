...
SECTIONS: tuple[tuple[str, str, str], ...] = (
    ...
    ("arsenal", "Arsenal", "ferramentas ativas e o que foi absorvido delas — gerado do registry."),
    ("workflows", "Workflows", "um resumo por fluxo: problema, cinco passos, ganho medido, limite."),
